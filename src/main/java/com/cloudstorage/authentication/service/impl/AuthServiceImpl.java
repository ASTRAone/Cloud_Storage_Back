...
import com.cloudstorage.user.api.UserApi;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse refreshToken(String token) {
        ...
        UserDto byKeycloakUuid = userApi.findByKeycloakUuid(session.data().getKeycloakUuid());
        return new AuthResponse(session.token(), new LoginResponse(byKeycloakUuid));
    }
